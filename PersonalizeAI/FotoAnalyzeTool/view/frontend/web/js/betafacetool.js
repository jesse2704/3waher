        ...
        var module = {
            ...
            listenForFacebookLink: function() {
                $(document).on('facebookLinked', function(event, data) {
                    ...
                    //this.analyzeFacebookProfilePic();
                }.bind(this));
            },
            ...
            analyzeFacebookProfilePic: async function() {
                ...
                try {
                    ...
                    if (data.media.faces == null) {
                    this.$result.html(`<pre>No face has been detected</pre>`);
                    return;
                    }
                    ...
                    this.$result.html(`<pre>Foto geanalyseerd</pre>`);
                } catch (error) {
            ...
            extractTags: function(data) {
                ...
                if (data.media && data.media.faces && Array.isArray(data.media.faces)) {
                    ...
                    this.$result.html(`<pre>Er is geen gezicht gedetecteerd</pre>`);
                }
                return allTags;
            },
            ...
            sendTagsToMagento: async function(tags) {
                ...
                var dataToSend = JSON.stringify({ tags: tags });
